...
GQBView.prototype.displayResultsByRow = function(rowStart,rowEnd) {
    ...
    for(; c < this.resultColumns.length; c++) {
        ...
        $('#gqbresulttablehead > tr').append($("<th style=\"padding: 2px;\"></th>").html("<table style=\"border-width: 0px; padding: 0px; width=100%;\"><tr>"+
                (((this.displayFirstColumn && c > 0) || c > 1) ? "<td style=\"border-width: 0px; padding: 0px; vertical-align:middle;\"><a cIdx="+c+" class=\"gqb-button-movecolleft\"><img src=\"../../../extensions/querybuilder/resources/images/toggle-lt.gif\" title='"+GQB.translate("moveColLeftLabel")+"'></a></td>" : "")+
                ...
                "<div style='width: 38px; float: right;' class='gqb-button-sort'><a cIdx="+c+" class=\"gqb-button-sortdesc\"><img src='"+urlBase+"extensions/querybuilder/resources/images/icon-downarrow.png' title='"+GQB.translate("sortColDescMsg")+"' /></a>&nbsp;<a cIdx="+c+" class=\"gqb-button-sortasc\"><img src='../../../extensions/querybuilder/resources/images/icon-uparrow.png' title='"+GQB.translate("sortColAscMsg")+"' /></a></div>"+
                "</td>"+
                ((c < this.resultColumns.length - 1) ? "<td style=\"border-width: 0px; padding: 0px; vertical-align:middle;\"><a cIdx="+c+" class=\"gqb-button-movecolright\"><img src=\"../../../extensions/querybuilder/resources/images/toggle-rt.gif\" title='"+GQB.translate("moveColRightLabel")+"'></a></td>" : "")+
                "</tr></table>"));

        //$('#gqbresulttable thead tr').append($('<th style=\"vertical-align:baseline;\"></th>').html(""+(((this.displayFirstColumn && c > 0) || c > 1) ? "<a cIdx="+c+" class=\"gqb-button-movecolleft\"><img src=\"../../../extensions/querybuilder/resources/images/toggle-lt.gif\" title='"+GQB.translate("moveColLeftLabel")+"'></a>" : "") + (c < this.resultColumns.length - 1 ? "<a cIdx="+c+" class=\"gqb-button-movecolright\"><img src=\"../../../extensions/querybuilder/resources/images/toggle-rt.gif\" title='"+GQB.translate("moveColRightLabel")+"'></a>" : "") + "<div style='width: 38px; float: right;' class='gqb-button-sort'><a cIdx="+c+" class=\"gqb-button-sortdesc\"><img src='../../../extensions/querybuilder/resources/images/icon-downarrow.png' title='"+GQB.translate("sortColDescMsg")+"' /></a>&nbsp;<a cIdx="+c+" class=\"gqb-button-sortasc\"><img src='../../../extensions/querybuilder/resources/images/icon-uparrow.png' title='"+GQB.translate("sortColAscMsg")+"' /></a></div><span class=\"gqbcolumnheader\" colId=\""+c+"\">"+this.resultColumns[c][0].substring(0,1).toUpperCase()+this.resultColumns[c][0].substring(1)+"</span>&nbsp;&nbsp;"));
    }
