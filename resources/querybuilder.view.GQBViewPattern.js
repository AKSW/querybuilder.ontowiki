...
GQBViewClass.prototype.initAtPos = function(_x, _y, label) {
    ...
    this.raphTrashIcon = GQB.view.raphaelCanvas.image(urlBase+"extensions/querybuilder/resources/images/canvas-btn-close.png", this.x-1, this.y-1, 13, 13);
    ...
    this.raphSpinnerIcon = GQB.view.raphaelCanvas.image(urlBase+"extensions/querybuilder/resources/images/spinner.gif", this.x+this.width/2-8, this.y+this.height/2-8, 16, 16);
...
GQBViewClass.prototype.addBlackBoxIcon = function() {
    ...
    this.raphBlackBoxIcon = GQB.view.raphaelCanvas.image(urlBase+"extensions/querybuilder/resources/images/canvas-btn-open.png", this.x+this.width-15, this.y-1, 13, 13);
